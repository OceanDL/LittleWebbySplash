...
function jupiterx_get_content_width() {
	...
	if ( 'true' === jupiterx_get_option( 'jupiterx_content_full_width' ) ) {
		return '100%';
	}
...
function jupiterx_get_container_width( $ret = 'all' ) {
	// Container width.
	$layout_mode     = jupiterx_get_option( 'jupiterx_site_width', 'global', 'full_width' );
	$container_width = jupiterx_get_option(
