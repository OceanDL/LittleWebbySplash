...
JupiterX_Customizer::add_field( [
	...
	'section'  => $section,
	'column'   => '4',
	'label'    => __( 'Site Width', 'jupiterx' ),
	'default'  => 'full_width',
	'choices'  => [
		'full_width' => __( 'Full Width', 'jupiterx' ),
		'boxed'      => __( 'Boxed', 'jupiterx' ),
	],
] );
...
JupiterX_Customizer::add_field( [
	...
	'label'         => __( 'Container Width', 'jupiterx' ),
	'column'        => '4',
	'control_attrs' => [
		'style' => 'width: 112px',
	],
...
JupiterX_Customizer::add_field( [
	...
	'section'         => $section,
	'label'           => __( 'Header & Footer On Top of Border', 'jupiterx' ),
	'column'          => '6',
	'default'         => false,
	'active_callback' => [
		[
...
JupiterX_Customizer::add_field( [
	...
	'label'    => __( 'Scroll Top Button', 'jupiterx' ),
	'column'   => '6',
	'default'  => true,
] );
