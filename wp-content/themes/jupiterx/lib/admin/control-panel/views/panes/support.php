			...
			<div class="jupiterx-cp-support-item">
				...
				<div class="jupiterx-cp-support-item-hot-topics">
					...
					<ul>
						...
						<li>
							<img src="<?php echo esc_url( JUPITERX_ADMIN_URL . 'control-panel/assets/images/fire-solid-grey.svg' ); ?>" alt="<?php echo $hot_topic['title']; ?>">
							<a href="<?php echo esc_url( $hot_topic['link'] ); ?>" target="_blank"><?php echo $hot_topic['title']; ?></a>
						</li>
						<?php endforeach; ?>
					</ul>
				</div>
