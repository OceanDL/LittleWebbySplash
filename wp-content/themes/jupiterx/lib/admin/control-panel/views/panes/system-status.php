		...
		<thead class="thead-light">
			<tr>
				<th colspan="3" data-export-label="Database">
					<?php esc_html_e( 'Database', 'jupiterx' ); ?>
				</th>
			</tr>
		</thead>
	<tbody>
		<tr>
			<td data-export-label="Database Info">
				<?php esc_html_e( 'Database Size', 'jupiterx' ); ?>:
			</td>
			<td class="help">
				<a class="jupiterx-tooltip" data-content="<?php echo esc_attr__( 'Information about database.', 'jupiterx' ); ?>" href="#" data-toggle="popover" data-placement="top"></a>
			</td>
			<td>
			<?php
		...
		<tr>
			<td data-export-label="Theme Mods Info">
				<?php esc_html_e( 'Theme Mods Size', 'jupiterx' ); ?>:
			</td>
			<td class="help">
				<a class="jupiterx-tooltip" data-content="<?php echo esc_attr__( 'Size of customizer options.', 'jupiterx' ); ?>" href="#" data-toggle="popover" data-placement="top"></a>
			</td>
			<td>
				<?php
					$mods = get_theme_mods();
				...
				<?php if ( $has_numeric_value ) : ?>
					<span><a href="#" id="jupiterx-mods-cleanup" class="button button-secondary" data-nonce="<?php echo esc_attr( wp_create_nonce( 'jupiterx_mods_cleanup' ) ); ?>"> <?php esc_html_e( 'Cleanup', 'jupiterx' ); ?></a></span>
				<?php endif; ?>
			</td>
		</tr>
	</table>
