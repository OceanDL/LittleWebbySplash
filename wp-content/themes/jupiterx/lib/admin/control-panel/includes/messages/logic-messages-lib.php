...
function jupiterx_logic_message_helper( $which_page, $which_string, $which_type = 'user_msg' ) {
	...
	$plugin_management_messages = array(
		array(
			...
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 200)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Can not find plugin path in activate plugin func',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 201)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Plugin successfully added and activated.',
			'user_msg' => __( 'Your plugin has been successfully added and activated.', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Plugin directory is not writable.',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 202)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Successfull',
			'user_msg' => __( 'Congratulations,your operation has been done successfully', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Plugins source not found or it have invalid url',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 203)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Can not find {param} plugin path.',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 204)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Plugin parent directory is not writable - RPPM01x01.',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 205)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Plugin directory is not writable  - RPPM01x01',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 206)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Can not remove directory of plugin - RPPM01x01-Directory',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 207)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Can not remove directory of plugin - RPPM01x01-File',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 208)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Plugin you want to remove is not exist  - RPPM01x01',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 209)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Plugin you want to remove is still activated , deactive it first  - RPPM01x01.',
			'user_msg' => __( 'To remove your plugin, please deactivate it first and then try again.', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Can not find plugin head file name.',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 210)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Plugin successfully Updated.',
			'user_msg' => __( 'Your plugin have been successfully updated.', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Plugin successfully Removed.',
			'user_msg' => __( 'Your plugin have been successfully removed.', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Plugin list is not an array , use install method instead.',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 211)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'The plugin ({param}) you are looking for is not exist.',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 212)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Plugin list is empty',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 213)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => '{param} plugins installed successfully',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 214)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Plugin you want to remove is not exist  - RPPM01x01.',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 215)', 'jupiterx' ),
		),
		array(
			'sys_msg'  => 'Undefined',
			'user_msg' => __( 'Whoops! We seem to be having some problems. Please contact Support and supply the number shown and we\'ll be happy to figure this out for you. (code 216)', 'jupiterx' ),
		),
	);
