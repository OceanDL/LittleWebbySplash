...
if ( ! class_exists( 'Jet_Engine_Booking_Forms_Editor' ) ) {
	...
	class Jet_Engine_Booking_Forms_Editor {
		...
		public function enqueue_assets() {
			...
			wp_enqueue_script(
				'vue-js',
				jet_engine()->plugin_url( 'assets/lib/vue/vue.min.js' ),
				'2.5.16',
				jet_engine()->get_version(),
				true
			);
...
- Post ID: %post_id%",
			...
			if ( ! $form_data || '[]' === $form_data ) {
				$form_data   = array(
					...
					array(
						...
						'i'        => '1',
						'settings' => array(
							'label'      => __( 'Book Now', 'jet-engine' ),
							'name'       => __( 'Book Now', 'jet-engine' ),
							'is_message' => false,
							'is_submit'  => true,
							'type'       => 'submit',
							'alignment'  => 'right',
		...
		public function add_menu_page() {
			...
			add_submenu_page(
				...
				esc_html__( 'Booking Forms', 'jet-engine' ),
				esc_html__( 'Booking Forms', 'jet-engine' ),
				'edit_pages',
		...
		public function register_post_type() {
			...
			$args = array(
				'labels' => array(
					'name'               => esc_html__( 'Booking Forms', 'jet-engine' ),
					...
					'menu_name'          => esc_html__( 'Booking Forms', 'jet-engine' ),
				),
				'public'              => true,
				'show_ui'             => true,
