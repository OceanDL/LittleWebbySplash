...
var Templates = function Templates() {
  ...
  function prependBadge() {
    var templateRemote = $('#tmpl-elementor-template-library-template-remote'),
...
},{"./components/custom-css":1,"./components/templates":2,"./controls/checkbox":3,"./controls/file-uploader":4,"./controls/media":5,"./utils/form":7,"./utils/module":8,"./widgets/categories":9,"./widgets/form":10}],7:[function(require,module,exports){
'use strict';
...
var Form = _module2.default.extend({
  ...
  getRepeaterItemsByLabel: function getRepeaterItemsByLabel(propertyName, filter) {
    var items = {};
    var fieldItems = this.getElementSettings(propertyName);

    _.filter(fieldItems.models, function (item) {
      if (filter && item.attributes.type !== filter) {
        return;
      }

      items[item.attributes._id] = item.attributes.label;
    });
...
exports.default = function (panel, model, view) {
  var Categories = _module2.default.extend({
    ...
    doAjax: function doAjax() {
      ...
      var controlView = self.getControlView('specific_categories');
      controlView.setValue('');

      wp.ajax.send('raven_categories_editor', {
        data: {
          post_type: self.getElementSettings('source')
        },
...
},{"../utils/module":8}],10:[function(require,module,exports){
'use strict';
...
},{"./forms/hubspot":11,"./forms/mailchimp":12}],11:[function(require,module,exports){
'use strict';
...
exports.default = function (panel, model, view) {
  var Hubspot = _module2.default.extend({
    ...
    onSectionActivated: function onSectionActivated(activeSection, section) {
      ...
      if (section.model.id !== this.getID()) {
        return;
      }
...
},{"./../../utils/module":8}],12:[function(require,module,exports){
'use strict';
...
exports.default = function (panel, model, view) {
  var Mailchimp = _form2.default.extend({
    ...
    doSuccess: function doSuccess(response) {
      ...
      var options = {};
      var lists = {};
      var mailchimpList = this.getElementSettings(self.action + '_list');
