...
<?php
    ...
    <div class="mk-blog-meta">
        ...
        <?php
            echo do_shortcode( '[mk_button dimension="flat" corner_style="rounded" bg_color="'.$skin_color.'" btn_hover_bg="'.hexDarker($skin_color, 30).'" text_color="light" btn_hover_txt_color="#ffffff" size="medium" target="_self" align="none" url="' . esc_url( get_permalink() ) . '"]'.__('READ MORE', 'mk_framework').'[/mk_button]' );
        ?>
