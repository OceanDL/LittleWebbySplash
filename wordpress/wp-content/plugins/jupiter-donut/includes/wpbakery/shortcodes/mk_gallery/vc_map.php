...
vc_map(array(
    ...
    "params" => array(
        ...
        array(
            ...
            "description" => sprintf(__("In grid style you will need to set column and image heights. For Mansory Styles Structure see below image :%s", 'mk_framework'), "</br><img src='" . JUPITER_DONUT_ASSETS_URL . "/img/gallery-mansory-styles.png' /><br>"),
            "param_name" => "style",
            "value" => array(
