...
Mk_Register_Custom_Post_Type(
	'clients', __( 'Clients', 'mk_framework' ), $supports = array(
		'title',
		'thumbnail',
		'page-attributes',
		'revisions',
...
Mk_Register_Custom_Post_Type(
	'animated-columns', __( 'Animated Columns', 'mk_framework' ), $supports = array(
		'title',
		'page-attributes',
		'revisions',
	) , $args = array(
...
Mk_Register_Custom_Post_Type(
	'banner_builder', __( 'Banner Builder', 'mk_framework' ), $supports = array(
		'title',
		'editor',
		'thumbnail',
		'page-attributes',
...
Mk_Register_Custom_Post_Type(
	'edge', __( 'Edge', 'mk_framework' ), $supports = array(
		'title',
		'page-attributes',
		'editor',
		'revisions',
		...
		'menu_name' => sprintf( __( '%s', 'mk_framework' ) , 'Edge Slider' ),
...
Mk_Register_Custom_Post_Type(
	'employees', __( 'Employees', 'mk_framework' ), $supports = array(
		'title',
		'editor',
		'thumbnail',
		'page-attributes',
...
Mk_Register_custom_taxonomy(
	'employees_category', __( 'Employees Category', 'mk_framework' ), 'employees', array(
		'rewrite' => array(
...
Mk_Register_Custom_Post_Type(
	'faq', __( 'Faq', 'mk_framework' ), $supports = array(
		'title',
		'editor',
		'page-attributes',
		'revisions',
		...
		'has_archive' => __( 'faq-items', 'mk_framework' ),
		'rewrite' => array(
			'slug' => __( 'faq-items', 'mk_framework' ),
		),
	) , $singular = true
);
...
/*-----------------------------------------------------------------------------------*/
$news_slug = jupiter_donut_get_option( 'news_slug' );
Mk_Register_Custom_Post_Type(
	'news', __( 'News', 'mk_framework' ), $supports = array(
		'title',
		'editor',
		'excerpt',
		'thumbnail',
...
$portfolio_slug = jupiter_donut_get_option( 'portfolio_slug' );
Mk_Register_Custom_Post_Type(
	'portfolio', __( 'Portfolio', 'mk_framework' ), $supports = array(
		'title',
		'editor',
		'author',
		'excerpt',
 ...
 */
$portfolio_cat_slug = jupiter_donut_get_option( 'portfolio_cat_slug' );

Mk_Register_custom_taxonomy(
	'portfolio_category', __( 'Portfolio Category', 'mk_framework' ), 'portfolio', array(
		'rewrite' => array(
...
Mk_Register_Custom_Post_Type(
	'pricing', __( 'Pricing', 'mk_framework' ), $supports = array(
		'title',
		'thumbnail',
		'page-attributes',
		'revisions',
		...
		'menu_name' => sprintf( __( '%s', 'mk_framework' ) , 'Pricing Table' ),
...
Mk_Register_Custom_Post_Type(
	'slideshow', __( 'Slideshow', 'mk_framework' ), $supports = array(
		'title',
		'page-attributes',
		'thumbnail',
	) , $args = array(
		...
		'menu_name' => sprintf( __( '%s', 'mk_framework' ) , 'FlexSlider' ),
...
Mk_Register_Custom_Post_Type(
	'tab_slider', __( 'Tab Slider', 'mk_framework' ), $supports = array(
		'title',
		'thumbnail',
		'page-attributes',
		'revisions',
...
Mk_Register_Custom_Post_Type(
	'testimonial', __( 'Testimonial', 'mk_framework' ), $supports = array(
		'title',
		'thumbnail',
		'page-attributes',
		'revisions',
...
Mk_Register_custom_taxonomy(
	'testimonial_category', __( 'Testimonial Category', 'mk_framework' ), 'testimonial', array(
		'rewrite' => array(
...
Mk_Register_Custom_Post_Type(
	'photo_album', __( 'Photo Album', 'mk_framework' ), $supports = array(
		'title',
		'thumbnail',
		'page-attributes',
		'revisions',
