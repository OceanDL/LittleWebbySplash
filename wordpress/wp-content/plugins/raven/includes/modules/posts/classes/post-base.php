...
abstract class Post_Base extends Action_Base {
	...
	protected function register_icons_controls() {
		...
		$this->skin->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .raven-post-overlay-icons i' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->skin->add_group_control(
			...
			[
				...
				'exclude' => [ 'image' ],
				'selector' => '{{WRAPPER}} .raven-post-overlay-icons i',
			]
		);
		...
		$this->skin->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .raven-post-overlay-icons i:not(:hover)',
			]
		);
	...
	protected function get_render_overlay() {
		...
		<?php if ( 'yes' === $show_quick_view && ! empty( $quick_view_icon ) ) : ?>
		...
		<?php endif; ?>
		<?php if ( 'yes' === $show_permalink && ! empty( $permalink_icon ) ) : ?>
	...
	protected function get_render_date() {
		...
		return '<a class="raven-post-meta-item raven-post-date" href="' . get_permalink() . '" rel="bookmark">' . get_the_date() . '</a>';
	}
