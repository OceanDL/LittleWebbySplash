	...
	<table class="jupiterx-comparison-table">
		...
		<tr>
			...
			<td class="jupiterx-ct-text-center jupiterx-ct-bg-normal">
				<a href="<?php echo esc_attr( jupiterx_upgrade_link( 'comparison' ) ); ?>" class="btn btn-large jupiterx-btn-upgrade-pro" target="_blank"><?php esc_html_e( 'Upgrade now', 'jupiterx' ); ?></a>
