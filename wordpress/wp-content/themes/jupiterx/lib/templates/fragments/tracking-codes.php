...
function jupiterx_add_tracking_codes_after_head() {
	echo stripslashes( get_option( 'jupiterx_tracking_codes_after_head' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
}
...
function jupiterx_add_tracking_codes_before_head() {
	echo stripslashes( get_option( 'jupiterx_tracking_codes_before_head' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
}
...
function jupiterx_add_tracking_codes_after_body() {
	echo stripslashes( get_option( 'jupiterx_tracking_codes_after_body' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
}
...
function jupiterx_add_tracking_codes_before_body() {
	echo stripslashes( get_option( 'jupiterx_tracking_codes_before_body' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
}
